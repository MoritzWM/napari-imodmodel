    ...
    for obj in model.objects:
        ...
        for mesh in obj.meshes:
            ...
            if mesh.face_values is None:
                yield (mesh.vertices, mesh.indices), dict(vertex_colors=vertex_colors, shading="smooth"), "surface"
            else:
                yield (mesh.vertices, mesh.indices, mesh.face_values), dict(vertex_colors=vertex_colors, shading="smooth"), "surface"
